    ...
    var body: some View {
        ...
        .sheet(isPresented: $showExportSheet) {
            StatsExportSheet(
                ...
                // Royal-only figures are withheld from the export itself, not
                // just hidden in the layout — Share would otherwise hand a free
                // user exactly what the lock covers.
